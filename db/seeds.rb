...
Artist.create(name: "Lady Gaga", image: "https://www.billboard.com/wp-content/uploads/media/05-lady-gaga-migos-memes-billboard-1548.jpg?w=942&h=623&crop=1", snapshot_id: 1)

Artist.create(name: "Magic Giant", image: "https://pbs.twimg.com/profile_images/1195204890240462848/xYfAmcXC_400x400.jpg", snapshot_id: 1)
...
Artist.create(name: "Hozier", image: "https://www.rollingstone.com/wp-content/uploads/2018/08/hozier-press-photo.jpg", snapshot_id: 2)

Artist.create(name: "Mac Miller", image: "https://i.scdn.co/image/ab6761610000e5ebed3b89aa602145fde71a163a", snapshot_id: 3)

Artist.create(name: "Brian Fallon", image: "https://media.stubhubstatic.com/stubhub-catalog/d_defaultLogo.jpg/t_f-fs-0fv,q_auto:low,f_auto,c_fill,$w_280_mul_3,$h_180_mul_3/performer/483988/image", snapshot_id: 3)
...
Artist.create(name: "Generationals", image: "https://www.roughtradepublishing.com/wp-content/uploads/2017/06/Generationals.jpg", snapshot_id: 4)

Song.create(title: "Million Bucks", artist: "smallpools", album: "Million Bucks", album_art: "https://atwoodmagazine.com/wp-content/uploads/2017/06/Million-Bucks-Smallpools-single-art.jpg", snapshot_id: 1)

Song.create(title: "Dive", artist: "Coast Modern", album: "Coast Modern", album_art: "https://i.scdn.co/image/ab67616d0000b2732fd2abcce5c533647221bc85", snapshot_id: 1)

Song.create(title: "Los Ageless", artist: "St. Vincent", album: "MASSEDUCTION", album_art: "https://media.pitchfork.com/photos/59aff367c6078536656ede7b/1:1/w_620,h_620,c_limit/STV-MASSEDUCTION-PACKSHOT.jpg", snapshot_id: 2)

Song.create(title: "Almost (Sweet Music)", artist: "Hozier", album: "Wasteland, Baby!", album_art: "https://m.media-amazon.com/images/I/718WDEiQGUL._SS500_.jpg", snapshot_id: 2)
...
Genre.create(title: "EDM", snapshot_id: 1)

Genre.create(title: "Hip-Hop", snapshot_id: 1)

Genre.create(title: "Dance", snapshot_id: 1)

Genre.create(title: "Indie", snapshot_id: 2)

Genre.create(title: "Chill", snapshot_id: 2)

Genre.create(title: "Alternative", snapshot_id: 3)

Genre.create(title: "Caribbean", snapshot_id: 3)

Genre.create(title: "Metal", snapshot_id: 4)

Genre.create(title: "Hip-Hop", snapshot_id: 4)
